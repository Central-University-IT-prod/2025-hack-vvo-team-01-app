...
export class Migration1745726061573 implements MigrationInterface {
  name = 'Migration1745726061573';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "participant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "score" integer NOT NULL DEFAULT '0', "matchesPlayed" integer NOT NULL DEFAULT '0', "wins" integer NOT NULL DEFAULT '0', "losses" integer NOT NULL DEFAULT '0', "draws" integer NOT NULL DEFAULT '0', "goalsScored" integer NOT NULL DEFAULT '0', "goalsConceded" integer NOT NULL DEFAULT '0', "winRate" double precision NOT NULL DEFAULT '0', "tournamentId" uuid, "userId" uuid, "teamId" uuid, CONSTRAINT "PK_64da4237f502041781ca15d4c41" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "team_statistics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "matchesPlayed" integer NOT NULL DEFAULT '0', "wins" integer NOT NULL DEFAULT '0', "losses" integer NOT NULL DEFAULT '0', "draws" integer NOT NULL DEFAULT '0', "winRate" double precision NOT NULL DEFAULT '0', "totalPoints" integer NOT NULL DEFAULT '0', "goalsScored" integer NOT NULL DEFAULT '0', "goalsConceded" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "teamId" uuid, "sportId" uuid, CONSTRAINT "PK_a6c91d538084e23aa249777b292" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_statistics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "matchesPlayed" integer NOT NULL DEFAULT '0', "wins" integer NOT NULL DEFAULT '0', "losses" integer NOT NULL DEFAULT '0', "draws" integer NOT NULL DEFAULT '0', "winRate" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "sportId" uuid, CONSTRAINT "PK_fa0c135e6eb8b7d6507c0461b61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."sport_scoringtype_enum" AS ENUM('goals', 'win_lose')`,
    );
    await queryRunner.query(
      `CREATE TABLE "sport" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "scoringType" "public"."sport_scoringtype_enum" NOT NULL DEFAULT 'goals', "isTeamBased" boolean NOT NULL DEFAULT false, "pointsForWin" integer NOT NULL DEFAULT '3', "pointsForDraw" integer NOT NULL DEFAULT '1', "pointsForLoss" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c67275331afac347120a1032825" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "team_statistics" ADD CONSTRAINT "FK_558efc81ca588e0ddbba9e77a2f" FOREIGN KEY ("teamId") REFERENCES "team"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "team_statistics" ADD CONSTRAINT "FK_b2df3b988b47e5997f52d5d888b" FOREIGN KEY ("sportId") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_statistics" ADD CONSTRAINT "FK_163d3173e678c93fd100a337976" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_statistics" ADD CONSTRAINT "FK_ef8adfc37da6b2339bb5d0a52df" FOREIGN KEY ("sportId") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_statistics" DROP CONSTRAINT "FK_ef8adfc37da6b2339bb5d0a52df"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "team_statistics" DROP CONSTRAINT "FK_b2df3b988b47e5997f52d5d888b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "team_statistics" DROP CONSTRAINT "FK_558efc81ca588e0ddbba9e77a2f"`,
    );
    await queryRunner.query(
